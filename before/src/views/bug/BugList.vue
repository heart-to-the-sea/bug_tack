<template>
  <div class="bug-list">
    ...
    <div class="pagination">
      <span class="pagination-info">共 {{ bugs.length }} 条记录</span>
      <el-pagination
  ...
  setup() {
    ...
    const filteredBugs = computed(() => {
      return bugs.value.filter((bug) => {
        const matchKeyword =
          !searchKeyword.value || bug.title.includes(searchKeyword.value);
        const matchProject =
          !filterProject.value || bug.project === filterProject.value;
        const matchStatus =
          !filterStatus.value || bug.status === filterStatus.value;
        const matchPriority =
          !filterPriority.value || bug.priority === filterPriority.value;
